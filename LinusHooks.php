...
class LinusHooks
{
    ...
    public static function setupSMWExtensions()
    {
    ...
    public static function countSections(OutputPage &$out, ParserOutput $parseroutput)
    {
    ...
    // Replaces category pages with a responsive version
  public static function onArticleFromTitle(Title &$title, &$article, $context)
  {
    ...
    public static function styleEditButtons(&$editpage, &$buttons, &$tabindex)
    {
    ...
    public static function parseMagicWords(Parser &$parser, &$text)
    {
    ...
    public static function NavSetup(Parser $parser)
    {
    ...
    public static function buildNavigation($input, array $args, Parser $parser, PPFrame $frame)
    {
        $classes = 'nav';
        if (isset($args['class'])) {
            $classes .= ' '.$args['class'];
    ...
    public static function ButtonsSetup(Parser $parser)
    {
...
class LinusCategoryViewer extends CategoryViewer
{
    ...
    public function formatList($articles, $articles_start_char, $cutoff = 6)
    {
